...
#ifndef PRIME_WINDOWS_WINDOWSCLOCK_H
#define PRIME_WINDOWS_WINDOWSCLOCK_H

#include "../DateTime.h"

namespace Prime {

class PRIME_PUBLIC WindowsClock {
public:
    ...
    /// Returns a monotonic time as a NanosecondTime. The resolution of this time is disappointing on some platforms.
    static NanosecondTime getMonotonicTime() PRIME_NOEXCEPT;
